...
#define KISS_TX_TELEMETRY_PRIORITY 3
#define KISS_TX_BULK_PRIORITY 4
#define KISS_TX_TELEMETRY_QUEUE_HIGH_WATERMARK 2
#define KISS_TX_TELEMETRY_AIRTIME_HIGH_WATERMARK_MS 2600UL
#define KISS_TX_BULK_QUEUE_HIGH_WATERMARK 1
#define KISS_TX_BULK_AIRTIME_HIGH_WATERMARK_MS 1500UL
#define KISS_TX_DATA_ADMISSION_BACKOFF_MIN_MS 250UL
#define KISS_TX_DATA_ADMISSION_BACKOFF_MAX_MS 8000UL
...
#define KISS_TX_SHARED_CHANNEL_LEASE_EFFECTIVE_CAP_MS 2500UL
...
#define KISS_ADMISSION_CONFIG_PAYLOAD_LEN 33
...
#define KISS_FIRMWARE_VERSION 39
...
#define CINDER_NATIVE_PACKET_DATA_DIRECT 0x01
#define CINDER_NATIVE_PACKET_DATA_GROUP  0x02
#define CINDER_NATIVE_PACKET_ACK         0x03
#define CINDER_NATIVE_PACKET_NACK        0x04
#define CINDER_NATIVE_PACKET_NODE_ADVERT 0x05
#define CINDER_NATIVE_PACKET_REACHABILITY 0x06
...
#define CINDER_TRAFFIC_CLASS_STORE_CONTROL 0x04
#define CINDER_TRAFFIC_CLASS_BULK        0x05
...
class KissModem {
  ...
  uint32_t _observed_rx_guard_min_ms;
  uint32_t _observed_rx_guard_max_ms;
